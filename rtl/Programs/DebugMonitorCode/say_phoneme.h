...
#define SYN_BASE 0xf0044000
#define SYN_SEL (*(volatile unsigned char *)(SYN_BASE + 0x1))
#define SYN_BUSY (*(volatile unsigned char *)(SYN_BASE + 0x3))
#define SYN_RDY (*(volatile unsigned char *)(SYN_BASE + 0x5))
