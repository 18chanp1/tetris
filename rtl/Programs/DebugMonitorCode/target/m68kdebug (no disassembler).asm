; C:\proj\tetris\RTL\PROGRAMS\DEBUGMONITORCODE\M68KDEBUG (NO DISASSEMBLER).C - Compiled by CC68K  Version 5.00 (c) 1991-2005  Peter J. Fondse
...
; #define TIMER5_DATA     (*(volatile unsigned char *)(0x00400130))
; #define TIMER5_CONTROL  (*(volatile unsigned char *)(0x00400132))
; #define TIMER5_STATUS   (*(volatile unsigned char *)(0x00400132))
...
say_phoneme_1:
       ...
       bra       say_phoneme_1
say_phoneme_3:
; SYN_SEL = phoneme_code;
       move.b    11(A6),-268156927
       unlk      A6
       rts
...
; void incrementTimer()
; {
       xdef      _incrementTimer
_incrementTimer:
       link      A6,#-4
; char* incrMsg;
; clockTimer+= 10;
       add.l     #10,_clockTimer.L
; TIMER5_CONTROL = 0x03;
       move.b    #3,4194610
       unlk      A6
       rts
...
; char c ;
; int i, j ;
; char *BugMessage = "DE1-68k Bug V1.77\r\ Paco Chan's (82033788)  Final Project 2023W2";
       lea       @m68kde~1_119.L,A0
       move.l    A0,-8(A6)
       lea       @m68kde~1_120.L,A0
       move.l    A0,-4(A6)
; KillAllBreakPoints() ;
       jsr       _KillAllBreakPoints
...
; clockTimer = 0;
       clr.l     _clockTimer.L
; InstallExceptionHandler(incrementTimer, 27);
       pea       27
       pea       _incrementTimer.L
       jsr       (A2)
       addq.w    #8,A7
; TIMER5_DATA = 0x03;
       move.b    #3,4194608
...
@m68kde~1_119:
       ...
       dc.b      46,55,55,13,32,80,97,99,111,32,67,104,97,110
       dc.b      39,115,32,40,56,50,48,51,51,55,56,56,41,32,83
       dc.b      111,108,117,116,105,111,110,32,70,105,110,97
       dc.b      108,32,80,114,111,106,101,99,116,32,50,48,50
       dc.b      51,87,50,0
@m68kde~1_120:
